...
const I18N_EN = {
  ...
  _og_description: "No broker, no third party. Your keys, your funds. Five algorithms trade gold 24/7 directly on-chain via gTrade. Three are placing orders today. Live on Base mainnet since May 1, 2026. Backtest history available on the protocol. Past performance does not guarantee future results. From $10.",
  ...
  token_ft5: `Deposit bonus`,
  token_f5: `Up to +5% in KAL on your deposits`,
  token_ft6: `Governance`,
  token_f6: `On-chain community votes + dedicated interface`,
  ...
  counter_status: "Open",
  counter_lead: "Tier 2 Community open until September 16, 2026 at 6:00 p.m. Swiss time, at $0.70 per KAL, with a $500 cap per wallet, outside the European Union.",
  ...
  counter_foot: "Until Tier 2 Community closes, a bound written into the contract at September 16, 2026, 4:00 p.m. UTC. Participation in a decentralised protocol, no guaranteed value, total loss possible.",
  ...
  presale_desc: "The presale opens by circles, from the closest to the broadest. The public opening of September 14 remains conditional on the viability threshold.",
  alpha_label: "Alpha phase, closed",
  alpha_h: "May 8, 2026, closed on July 15",
  alpha_status: "Private, by invitation",
  alpha_price_bonus: "+ 20% bonus, tier closed",
  alpha_p: "Bootstrap tier at $0.30 per KAL, closed on July 15, 2026; it was reserved for the close circle by direct Telegram invitation. Tier 1 Strategic followed. Tier 2 Community is live. The Public phase opens later to the broader community.",
  alpha_meta_l1: "Access:",
  alpha_meta_v1: "Direct Telegram invitation",
  alpha_meta_l2: "Tier:",
  alpha_meta_v2: "Bootstrap closed, $0.30 per KAL, 20% bonus",
  beta_label: "Beta phase",
  beta_h: "Live since July 15, 2026",
  beta_p: `Tier 1 Strategic closed on August 15, 2026 at 6 p.m. Swiss time. Tier 2 Community has been open since August 16, 2026 at $0.70 per KAL, until September 16, 2026 at 6 p.m. Swiss time. Access is for the broader Telegram community residing outside the European Union. Combined cap 100,000 KAL = $60,000 maximum raised. <strong style="color: var(--red);">Not available to EU residents for MiCA compliance reasons.</strong>`,
  ...
  faq_1_a: "Kal Mydas is a DeFi ecosystem offering 5 algorithmic gold (XAUUSD) trading strategies. 3 are placing orders today, REVOLUTION, TREASURY and ORION. HORIZON and VALKYRIE are in place and not yet operating. Bots execute trades automatically, 24/7. Everything is transparent and verifiable on-chain (Base for mainnet, Arbitrum Sepolia for testnet).",
  ...
  faq_5_a: "No entry or exit fees. Performance fees of 10% on HORIZON and 20% on the four other strategies, charged on new gains thanks to the High-Water Mark system. No management fee is charged today, the rate is zero on all five contracts.",
  ...
  about_token_desc2: `The KAL token (<span class="g-term" data-g="erc20">ERC-20</span>, 10M max supply) uses a transparent <span class="g-term" data-g="bonding_curve">bonding curve</span>, the price moves with adoption. 20% of performance fees are used for buyback then redirection into the protocol's KalSwap KAL/USDC liquidity pool, through the <span class="g-term" data-g="pol">BuybackRecirculator</span> contract (Zero Burn doctrine, no destruction). Lock your KAL as <span class="g-term" data-g="vekal">veKAL</span>. The protocol pays a weekly share of its fees in <span class="g-term" data-g="usdc">USDC</span>. This is the indemnity for the technical service that remunerates securing and governance. It does not follow strategy results.`,
