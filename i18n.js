...
const I18N_EN = {
  ...
  road_3_p: `Access to the protocol is open to everyone. The protocol has been running on <span class="g-term" data-g="base_l2">Base</span> since 1 May 2026. A new generation of contracts has been in service since 20 September 2026.`,
  ...
  about_token_desc2: `The KAL token (<span class="g-term" data-g="erc20">ERC-20</span>, 10M max supply) uses a public <span class="g-term" data-g="bonding_curve">bonding curve</span> written into the contract. 20% of performance fees are used for buyback then redirection into the protocol's KalSwap KAL/USDC liquidity pool, through the <span class="g-term" data-g="pol">BuybackRecirculator</span> contract (Zero Burn doctrine, no destruction). Lock your KAL as <span class="g-term" data-g="vekal">veKAL</span>. The protocol pays a weekly share of its fees in <span class="g-term" data-g="usdc">USDC</span>. This is the indemnity for the technical service that remunerates securing and governance. It does not follow strategy results.`,
  ...
  about_tl_4: "<strong>Growth</strong>, public veKAL incentives, DAO governance, mobile app",
