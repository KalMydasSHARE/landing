...
const I18N_EN = {
  ...
  token_ft3: `Fee sharing`,
  token_f3: `Lock your KAL as <span class="g-term" data-g="vekal">veKAL</span> to receive your share of fees in <span class="g-term" data-g="usdc">USDC</span> every week`,
  ...
  counter_status: "Open",
  counter_lead: "Strategic tier open until August 15, 2026, outside the European Union.",
  ...
  counter_foot: "Until the Tier 1 STRATEGIC close. Indicative schedule, subject to adjustment depending on market conditions. Participation in a decentralised protocol, no guaranteed value, total loss possible.",
  ...
  alpha_p: "Bootstrap tier at $0.30 per KAL, closed on July 15, 2026; it was reserved for the close circle by direct Telegram invitation. The Strategic tier at $0.50 is now live. The Public phase opens later to the broader community.",
  ...
  beta_p: `STRATEGIC tier open since July 15, 2026 at $0.50 per KAL, until August 15, 2026 at 6 p.m. Swiss time. The COMMUNITY tier is not open yet. Access is for the broader Telegram community residing outside the European Union. Combined cap 100,000 KAL = $60,000 maximum raised. <strong style="color: var(--red);">Not available to EU residents for MiCA compliance reasons.</strong>`,
